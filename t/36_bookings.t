...
like($feature_catalog_html, qr/data-feature-key="bookings"[^>]+data-feature-available="1"/, 'feature catalog renders Bookings available by plan');
like($feature_catalog_html, qr/data-feature-key="booking_payments"/, 'feature catalog renders Booking Deposits feature card');
