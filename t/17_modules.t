...
like($events_module_html, qr/module-setup-nav" aria-label="Module setup pages"><a href="\/admin\/settings\/modules" class="module-setup-nav-home"><strong>Modules<\/strong><small>Module Catalog<\/small><span>Module parent<\/span><\/a><span class="module-setup-nav-groups">.*data-module-setup-group="modules".*<span class="module-setup-nav-group-title">Core Modules<\/span><span class="module-setup-nav-links">.*href="\/admin\/settings\/modules\/events" class="active" aria-current="page">Events<\/a>.*href="\/admin\/settings\/modules\/directory">Directory<\/a>.*href="\/admin\/settings\/modules\/bookings">Bookings \/ Appointments<\/a>.*href="\/admin\/settings\/modules\/membership">Membership \/ Gated Content<\/a>.*href="\/admin\/settings\/modules\/newsletter">Newsletter<\/a>.*href="\/admin\/settings\/modules\/donations">Donations \/ Fundraising<\/a>.*href="\/admin\/settings\/modules\/testimonials">Testimonials \/ Reviews<\/a>.*href="\/admin\/settings\/modules\/shop">Shop \/ Catalog<\/a>.*data-module-setup-group="tools".*<span class="module-setup-nav-group-title">Site Tool Modules<\/span><span class="module-setup-nav-links">/s, 'module detail pages render compact grouped Modules setup nav with active first-party module');
...
like($contributor_feature_setup_nav, qr/module-setup-nav" aria-label="Feature setup pages"><a href="\/admin\/settings\/modules" class="module-setup-nav-home"><strong>Features<\/strong><small>Feature Catalog<\/small><span>Plan feature parent<\/span><\/a><span class="module-setup-nav-groups">.*data-module-setup-group="tools".*<span class="module-setup-nav-group-title">Site Tools<\/span><span class="module-setup-nav-links">.*href="\/admin\/settings\/modules\/map" class="active" aria-current="page">Map \/ Locations<\/a>.*href="\/admin\/settings\/modules\/showcase">Showcase<\/a>/s, 'contributor feature setup nav is plan-aware, compact, grouped, and product-labeled');
