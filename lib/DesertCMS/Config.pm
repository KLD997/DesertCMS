...
sub load {
    ...
    my %config = (
        ...
        account_session_cookie => 'desertcms_account_session',
        ...
        module_live_streaming_enabled => 0,
        module_forums_enabled    => 0,
        module_social_enabled    => 0,
        module_notifications_enabled => 1,
        module_security_center_enabled => 1,
        social_delete_window_seconds => 900,
        accounts_google_client_id => '',
        accounts_google_client_secret => '',
        accounts_google_enabled => 1,
        accounts_oidc_discovery_url => '',
        accounts_oidc_client_id => '',
        accounts_oidc_client_secret => '',
        accounts_oidc_enabled => 1,
        accounts_allowed_domains => '',
        account_password_reset_ttl_seconds => 3600,
        account_password_reset_max_requests => 3,
        account_password_reset_lockout_seconds => 3600,
        realtime_enabled         => 0,
        realtime_bind_host       => '127.0.0.1',
        realtime_port            => 8787,
        realtime_public_url      => '',
        realtime_allowed_origins => '',
        forum_edit_window_seconds => 900,
        forum_rate_window_seconds => 600,
        forum_max_posts_per_window => 30,
        forum_max_posts_per_ip_window => 30,
        forum_min_account_age_seconds => 0,
        live_ingest_protocol     => 'rtmp',
        live_ingest_host         => '',
        live_ingest_app          => 'live',
        live_ingest_endpoint     => '',
        live_hls_public_prefix   => '/streams',
        live_hls_output_dir      => '/var/www/htdocs/desertcms-site/streams',
        live_worker_health_path  => '/live/worker/health',
        live_chat_account_only   => 0,
        live_chat_slow_mode_seconds => 0,
        live_chat_delete_window_seconds => 900,
        live_chat_presence_stale_seconds => 120,
        theme_unsplash_enabled   => 0,
        unsplash_access_key      => '',
        theme_background_effect  => 'none',
        theme_motion_effect      => 'none',
        theme_lighting_effect    => 'none',
        theme_box_transparency   => '0',
        theme_outline_transparency => '0',
        theme_box_shape          => 'soft',
        theme_gradient_style     => 'none',
        docs_source_dir          => '',
        shop_domain             => '',
        shop_url                => '',
        commerce_model          => '',
